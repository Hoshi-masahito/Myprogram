...
class ConvNet(nn.Module):
	def __init__ (self, num_classes=10):
		...
		self.layer1 = nn.Sequential(
			nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1),#32*32*16
			nn.BatchNorm2d(16),
			nn.ReLU())
		...
		self.layer4 = nn.Sequential(
			nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1),#16*16*32
			nn.BatchNorm2d(32),
			nn.ReLU(),
			nn.MaxPool2d(kernel_size=2, stride=2))#8*8*32
